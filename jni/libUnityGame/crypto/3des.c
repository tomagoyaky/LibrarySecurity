...
static int  des3_set_3keys( des3_context *ctx, uint8 key1[8], uint8 key2[8],
                                        uint8 key3[8] );
static void des3_encrypt( des3_context *ctx,const  uint8 input[8], uint8 output[8] );
static void des3_decrypt( des3_context *ctx,const  uint8 input[8], uint8 output[8] );
...
__attribute__((__annotate__(("nocpi"))))
static void des3_crypt( uint32 SK[96], const  uint8 input[8], uint8 output[8] )
{
    uint32 X, Y, T;
